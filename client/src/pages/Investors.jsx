...
const handleMessage = (id, name) => {
  // One dispatch, both values updated
  dispatch(setReceiver({ id, name }));
            ...
            >
              <div className="flex flex-col md:flex-row gap-6">
                ...
                <div className="flex flex-row md:flex-col justify-end gap-3 mt-4 md:mt-0 min-w-[140px]">
                  <button className="flex-1 md:flex-none bg-black text-white px-4 py-2 rounded-lg text-sm font-semibold hover:bg-gray-800 transition-colors" onClick={()=>{handleMessage(ele._id,ele.fullName)}}>
                    Connect
                  </button>
